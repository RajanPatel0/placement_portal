...
@section('content')
    ...
    <div class="admin-header mb-3 p-3 bg-light rounded">
        ...
        <span class="ms-3 text-muted">Placement Officer View: {{ $user->name }}'s Profile</span>
    </div>
 ...
 <a href="{{ asset('/public/' . $userResume ->resume_path)}}" target="_blank" style="text-decoration: none;"
                                                     <span class="title-right">View</span>
                                                </a>
                @else
