    ...
    <body class="bg-gray-50">
                        ...
                        <div class="space-y-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div class="bg-indigo-50 border border-indigo-200 rounded-lg p-4">
                                    ...
                                    @if ($driveDetails->is_reappear == 1)
                                        <p class="text-gray-700">Reappear allowed</p>
                                    @else
                                        <p class="text-gray-700">Reappear not allowed</p>
                                    @endif
                                </div>
        ...
        <div id="editModal" class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50 hidden">
            <div class="bg-white rounded-xl shadow-2xl w-full max-w-4xl max-h-[90vh] overflow-y-auto">
                ...
                <form id="editForm" action="{{ route('placement-drive.company.update', $driveDetails->id) }}"
